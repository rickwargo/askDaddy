...
4. Name the Lambda Function "Ask-Daddy-Skill".
...
2. Set "Ask Daddy" as the skill name and "Daddy" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, ask Daddy for candy"
